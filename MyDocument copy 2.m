...
- (id)initWithType:(NSString *)typeName error:(NSError **)outError
{
	...
	NSImageView *theImageView = [[[MyImageView alloc] initWithFrame:NSMakeRect((CGFloat)0.0, (CGFloat)0.0, imageWidth, imageHeight)] autorelease];
	
	[[theImageView cell] setEditable:YES];
	[[theImageView cell] setFocusRingType:NSFocusRingTypeNone];
	[[theImageView cell] setImageScaling:NSImageScaleNone];
	[[theImageView cell] setImage:newImage];
	
	NSClipView *theClipView = [[[NSClipView alloc] initWithFrame:NSMakeRect((CGFloat)0.0, (CGFloat)0.0, theRect.size.width, theRect.size.height)] autorelease];
	
	[theClipView setBackgroundColor:[NSColor clearColor]];
	[theClipView setCopiesOnScroll:NO];
	[theClipView setDocumentView:theImageView];
	
	[theWindow setContentView:theClipView];
